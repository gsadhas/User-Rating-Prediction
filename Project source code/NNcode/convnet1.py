...
model = models.get_cnn_kmodel(x.shape[2], x.shape[1])
print "fitting data"
model.fit(x, y, nb_epoch=5, validation_split=0., show_accuracy=True,
          verbose=1, batch_size=32, shuffle=True)
print "saving model.."
models.save_cnn_model(model, "data/models/cnn5k")
# testing
# model = models.load_cnn_model(model_arch="data/models/cnn5kcnn_arch.json",model_weights="data/models/cnn5kcnn_weights")
